namespace ASP_BrewedCoffee_v2;
public class CFavoritesM
{
    private RequestDelegate Next;
    public CFavoritesM(RequestDelegate next)
    {
        Next = next;
    }
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        //context.Response.Cookies.Append("test", "test1", new CookieOptions() { MaxAge = new TimeSpan(0, 1, 0)});
